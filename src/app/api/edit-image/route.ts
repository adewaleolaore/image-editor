  ...
  try {
    ...
    const content = [
      ...
      },
      {
        ...
        Create a new version of this image that implements the requested changes while maintaining the same dimensions and overall composition suitable for a YouTube thumbnail. Keep all text readable and ensure the image remains visually appealing and engaging.
        
        Generate the edited image directly - don't just describe what should be changed.`
      }
    ];
